...
<div style="border: 2px solid green";><small style="color:red;"><span class="icon-warning-sign"></span><i> <b>Note:</b> This history note and physical exam note was generated by a community health worker with the support
